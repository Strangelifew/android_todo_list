...
import com.example.todolist.presentation.screens.details.TaskListDetailsActivity.Companion.startTaskListDetails
import com.example.todolist.presentation.screens.status.StatusListActivity.Companion.startStatusList
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launchWhenStarted {
            viewModel.taskListsFlow.collect { taskLists ->
                adapter.setItems(taskLists.map { it.toPO() })
            }
        }
    }
